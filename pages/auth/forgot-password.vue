  ...
  <section class="mx-auto max-w-md px-3 sm:px-4 py-16">
    ...
    <div class="rounded-2xl border border-navy-700/50 bg-gradient-to-br from-navy-800/60 to-navy-900/40 p-8 shadow-xl">
      ...
      <div v-else class="text-center">
        <NuxtLink
          to="/auth/login"
          class="inline-block rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-5 py-2.5 text-sm font-medium text-white hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl"
        >
          Back to Sign In
        </NuxtLink>
      </div>
