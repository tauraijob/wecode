      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm">
          <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <NuxtLink to="/admin/community/mentors" class="text-sm text-primary-600 hover:underline">View All</NuxtLink>
          </div>
          <div v-if="stats?.recentPendingMentors?.length" class="divide-y divide-slate-100">
            <div v-for="mentor in stats.recentPendingMentors" :key="mentor.id" class="px-5 py-3 flex items-center justify-between">
              ...
              <div class="flex gap-2">
                <button @click="approveMentor(mentor.id)" class="px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded-lg transition-colors">
                  Approve
                </button>
              </div>
            </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm">
          <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <NuxtLink to="/admin/community/users" class="text-sm text-primary-600 hover:underline">View All</NuxtLink>
          </div>
