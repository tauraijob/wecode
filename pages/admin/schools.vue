<template>
  <section class="mx-auto max-w-7xl px-3 sm:px-4 py-8">
    ...
    <div class="mb-6 sm:mb-8">
      ...
      <p class="mt-1 sm:mt-2 text-sm sm:text-base text-navy-300">Manage school partnerships and contacts</p>
    </div>
...
function exportCsv() {
  ...
  const lines = rows.value.map((r: any) => [r.name, r.contactEmail])
