  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 py-8">
    ...
    <div class="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
      <div>
        ...
        <p class="mt-1 sm:mt-2 text-sm sm:text-base text-navy-300">View and pay your invoices</p>
      </div>
      <button
          ...
          <div class="flex flex-col gap-2">
            <div class="flex gap-2">
              ...
              <button
                ...
                class="rounded-lg bg-gradient-to-r from-accent-500 to-emerald-600 px-4 py-2 text-sm font-medium text-white hover:from-accent-600 hover:to-emerald-700 transition-all flex items-center gap-1.5 shadow-lg hover:shadow-xl"
              >
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
