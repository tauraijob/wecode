        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-start justify-between gap-4">
              <div class="flex-1">
                ...
                <div v-if="getActionUrl(notification)" class="mt-4">
                  <NuxtLink
                    ...
                    @click.stop
                    class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 px-4 py-2 text-sm font-medium text-white hover:from-purple-600 hover:to-pink-700 transition-all"
                  >
              ...
              <div v-if="!notification.read" class="h-3 w-3 rounded-full bg-purple-500 flex-shrink-0 mt-1"></div>
            </div>
          </div>
        </div>
      </div>
...
const { data: notificationsData, refresh, pending: loading } = await useFetch('/api/instructor/notifications')
