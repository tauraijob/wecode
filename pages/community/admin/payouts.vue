          ...
          <div class="flex gap-2">
            <template v-if="payout.status === 'PENDING'">
              <button 
                ...
                class="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
              >
                Mark as Processed
              </button>
            </template>
        ...
        <div v-if="showProcessModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div class="bg-white rounded-xl w-full max-w-md p-6 shadow-xl">
            ...
            <div class="flex gap-3 justify-end">
              ...
              <button @click="process()" :disabled="processing" class="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg font-medium disabled:opacity-50">
                Confirm Processed
              </button>
            </div>
          </div>
