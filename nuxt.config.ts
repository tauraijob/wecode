  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'keywords', content: 'digital skills, programming, web development, cybersecurity, IT services, coding clubs, corporate training, Zimbabwe, Harare, technology education' },
        ...
        { property: 'og:description', content: 'Empowering Zimbabwe with digital skills training, IT services, and innovative products for a digital-first world.' },
