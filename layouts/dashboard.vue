<template>
  <div class="min-h-screen grid grid-cols-1 md:grid-cols-[240px_1fr] bg-navy-950 text-white">
    ...
    <!-- Notification Detail Modal (for instructors) -->
    <transition
      ...
      >
        <div class="w-full max-w-4xl rounded-2xl border border-navy-700/50 bg-gradient-to-br from-navy-900/95 to-navy-800/95 shadow-2xl">
            ...
            <div class="flex items-center gap-4">
              <div
                :class="{
                  ...
                  'bg-amber-500/20': selectedNotification.type === 'ENROLLMENT',
                  'bg-purple-500/20': !['COURSE_APPROVED', 'COURSE_REJECTED', 'COURSE_SUBMITTED', 'ENROLLMENT'].includes(selectedNotification.type)
                }"
                class="rounded-xl p-3"
              >
                <svg
                  v-if="selectedNotification.type === 'COURSE_APPROVED'"
                ...
                <svg
                  v-else-if="selectedNotification.type === 'ENROLLMENT'"
            ...
            <div class="flex items-center gap-3">
              <span
                :class="{
                  ...
                  'bg-amber-500/20 text-amber-400 border-amber-500/30': selectedNotification.type === 'ENROLLMENT',
                  'bg-purple-500/20 text-purple-400 border-purple-500/30': !['COURSE_APPROVED', 'COURSE_REJECTED', 'COURSE_SUBMITTED', 'ENROLLMENT'].includes(selectedNotification.type)
                }"
          ...
          <div class="border-t border-navy-700/50 bg-navy-800/30 px-6 py-4 flex justify-between items-center rounded-b-2xl">
            <button
              v-if="selectedNotification.type === 'COURSE_APPROVED' || selectedNotification.type === 'COURSE_REJECTED'"
