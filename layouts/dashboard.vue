  ...
  <div class="min-h-screen grid grid-cols-1 md:grid-cols-[260px_1fr] bg-navy-950 text-white">
    ...
    <aside class="hidden md:block border-r border-navy-800 bg-navy-900/30">
      <div class="flex items-center gap-3 p-4 border-b border-navy-800">
        <span class="inline-flex h-9 w-9 items-center justify-center rounded-md bg-gradient-to-br from-blue-500 to-purple-600 font-semibold text-white">WZ</span>
      ...
      <nav class="mt-2 space-y-1 px-2">
        ...
        <NuxtLink :to="'/dashboard/invoices'" :class="navClass('/dashboard/invoices')">
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
          <span>Invoices</span>
        </NuxtLink>
        <NuxtLink :to="'/dashboard/requests'" :class="navClass('/dashboard/requests')">
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
          <span>Requests</span>
        </NuxtLink>
        <NuxtLink :to="'/dashboard/clubs'" :class="navClass('/dashboard/clubs')">
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex flex-col">
      ...
      <header class="sticky top-0 z-30 flex items-center justify-between border-b border-navy-800 bg-navy-950/60 px-4 py-3 backdrop-blur">
        ...
        <div class="flex items-center gap-3 text-sm">
          <NuxtLink to="/" class="hidden sm:inline-block rounded-md bg-white/10 px-3 py-1.5 text-sm hover:bg-white/15 transition-colors">
            View Site
          </NuxtLink>
          <!-- User Menu -->
      ...
      <div v-if="open" class="fixed inset-0 z-40 grid md:hidden">
        ...
        <div class="absolute left-0 top-0 h-full w-72 border-r border-navy-800 bg-navy-900/95 backdrop-blur-lg p-4 overflow-y-auto">
          ...
          <nav class="space-y-1">
            ...
            <NuxtLink @click="open=false" :to="'/dashboard/invoices'" :class="navClass('/dashboard/invoices')">
              <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span>Invoices</span>
            </NuxtLink>
            <NuxtLink @click="open=false" :to="'/dashboard/requests'" :class="navClass('/dashboard/requests')">
              <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
              <span>Requests</span>
            </NuxtLink>
            <NuxtLink @click="open=false" :to="'/dashboard/clubs'" :class="navClass('/dashboard/clubs')">
              <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span>Clubs</span>
