  ...
  <div class="min-h-screen grid grid-cols-1 md:grid-cols-[260px_1fr] bg-navy-950 text-white">
    <aside class="hidden md:block border-r border-navy-800 bg-navy-900/30">
      ...
      <nav class="mt-2 space-y-1 px-2">
        ...
        <NuxtLink :to="'/admin/users'" :class="navClass('/admin/users')">Users</NuxtLink>
        <NuxtLink :to="'/admin/schools'" :class="navClass('/admin/schools')">Schools</NuxtLink>
        <NuxtLink :to="'/admin/clubs'" :class="navClass('/admin/clubs')">Clubs</NuxtLink>
        <NuxtLink :to="'/admin/requests'" :class="navClass('/admin/requests')">Requests</NuxtLink>
        <NuxtLink :to="'/admin/quotes'" :class="navClass('/admin/quotes')">Quotes</NuxtLink>
        <NuxtLink :to="'/admin/billing'" :class="navClass('/admin/billing')">Billing</NuxtLink>
      </nav>
    </aside>
    <div>
      ...
      <div v-if="open" class="fixed inset-0 z-40 grid md:hidden">
        ...
        <div class="absolute left-0 top-0 h-full w-72 border-r border-navy-800 bg-navy-900/95 p-4">
          ...
          <nav class="space-y-1">
            ...
            <NuxtLink @click="open=false" :to="'/admin/users'" :class="navClass('/admin/users')">Users</NuxtLink>
            <NuxtLink @click="open=false" :to="'/admin/schools'" :class="navClass('/admin/schools')">Schools</NuxtLink>
            <NuxtLink @click="open=false" :to="'/admin/clubs'" :class="navClass('/admin/clubs')">Clubs</NuxtLink>
            <NuxtLink @click="open=false" :to="'/admin/requests'" :class="navClass('/admin/requests')">Requests</NuxtLink>
            <NuxtLink @click="open=false" :to="'/admin/quotes'" :class="navClass('/admin/quotes')">Quotes</NuxtLink>
            <NuxtLink @click="open=false" :to="'/admin/billing'" :class="navClass('/admin/billing')">Billing</NuxtLink>
          </nav>
        </div>
      </div>
    </transition>
